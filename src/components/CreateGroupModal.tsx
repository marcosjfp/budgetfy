...
import { X, Users, Home, Plane, Briefcase, Sparkles } from 'lucide-react';
          ...
          >
            <div className="p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      { id: 'custom', label: 'Custom', icon: Sparkles, activeClass: 'bg-zinc-50 dark:bg-zinc-800 border-zinc-900 text-zinc-900 dark:text-white shadow-lg shadow-zinc-500/10', iconActive: 'text-zinc-600 dark:text-zinc-400' },
                    ].map((item) => (
                      <button
                        key={item.id}
                        type="button"
                ...
                >
                  <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-[0.2em] mb-4 font-display">Theme Color</label>
                  <div className="flex flex-wrap gap-3">
                    {COLORS.map((color) => (
                      <button
                        ...
                        className={`w-10 h-10 rounded-full ${color.bg} transition-all duration-200 flex items-center justify-center border-4 ${
                          themeColor === color.value ? 'border-white dark:border-zinc-800 scale-110 shadow-lg' : 'border-transparent scale-100'
                        }`}
                      >
